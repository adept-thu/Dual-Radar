...
#fangchange
class MineDataset_ARS548(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        ...
        #修改1  点数变为5
        points_ars548 = np.fromfile(str(lidar_file), dtype=np.float32).reshape(-1, 5)
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=16):
    #fangchange
    dataset = MineDataset_ARS548(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_mine_infos':
        ...
        create_kitti_infos(
            ...
            # fangchange
            data_path=ROOT_DIR / 'data' / 'mine' / 'radar_ars548',
            save_path=ROOT_DIR / 'data' / 'mine' / 'radar_ars548'
        )
