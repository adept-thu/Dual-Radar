...
class FrustumToVoxelWithPoint(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # sum voxelized feature from points
        point_features = batch_dict['multi_scale_3d_features']['x_conv2'].dense()
        point_features = F.interpolate(point_features, size=voxel_features.shape[-3:], mode='trilinear')
        voxel_features = voxel_features + point_features
